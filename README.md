...
| run_id | cell_id | experiment | model_key | model | provider | num_documents | num_keys | gold_index | n | accuracy | ci_low | ci_high | ci_n_resamples | ci_seed | is_mock | subset_signature |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| main_qa_freetier | gptoss20b__qa_closedbook | qa_closedbook | gptoss20b | openai/gpt-oss-20b | groq | — | — | — | 60 | 0.15 | 0.06666666666666667 | 0.25 | 10000 | 0 | False | be76cc152f4bd13e772eb5f747c1ab03 |
| main_qa_freetier | gptoss20b__qa_oracle | qa_oracle | gptoss20b | openai/gpt-oss-20b | groq | — | — | — | 60 | 0.3333333333333333 | 0.21666666666666667 | 0.45 | 10000 | 0 | False | be76cc152f4bd13e772eb5f747c1ab03 |
| main_qa_freetier | gptoss20b__qa_positional__docs20__gold0 | qa_positional | gptoss20b | openai/gpt-oss-20b | groq | 20 | — | 0 | 60 | 0.15 | 0.06666666666666667 | 0.25 | 10000 | 0 | False | be76cc152f4bd13e772eb5f747c1ab03 |
| main_qa_freetier | gptoss20b__qa_positional__docs20__gold14 | qa_positional | gptoss20b | openai/gpt-oss-20b | groq | 20 | — | 14 | 59 | 0.11864406779661017 | 0.05084745762711865 | 0.2033898305084746 | 10000 | 0 | False | be76cc152f4bd13e772eb5f747c1ab03 |
| main_qa_freetier | gptoss20b__qa_positional__docs20__gold19 | qa_positional | gptoss20b | openai/gpt-oss-20b | groq | 20 | — | 19 | 57 | 0.10526315789473684 | 0.03508771929824561 | 0.19298245614035087 | 10000 | 0 | False | be76cc152f4bd13e772eb5f747c1ab03 |
| main_qa_freetier | gptoss20b__qa_positional__docs20__gold4 | qa_positional | gptoss20b | openai/gpt-oss-20b | groq | 20 | — | 4 | 60 | 0.1 | 0.03333333333333333 | 0.18333333333333332 | 10000 | 0 | False | be76cc152f4bd13e772eb5f747c1ab03 |
| main_qa_freetier | gptoss20b__qa_positional__docs20__gold9 | qa_positional | gptoss20b | openai/gpt-oss-20b | groq | 20 | — | 9 | 60 | 0.06666666666666667 | 0.016666666666666666 | 0.13333333333333333 | 10000 | 0 | False | be76cc152f4bd13e772eb5f747c1ab03 |

Report the minimum detectable effect alongside these numbers — an observed effect smaller than the MDE means *underpowered*, not *absent*.

<sub>Generated from `results/summary.csv`, measured 2026-09-15 14:24 UTC. `runs: main_qa_freetier` · `n_per_cell: 61` · Not hand-entered — regenerate with `publish-results.py`.</sub>
<!-- RESULTS:END -->
